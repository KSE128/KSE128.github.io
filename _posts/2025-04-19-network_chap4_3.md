...
(f_kk - f*_kk)의 절댓값으로 이루어졌을 때의 높은 값은 예상보다 강력한 내부 응집력을 나타냅니다. 이는 의미있는 community 구조의 특징을 나타냅니다.
...
<img src="{{site.url}}\images\2025-04-19-network_chap4_3\hirarch.PNG" alt="hirarch" style="zoom: 50%;" />
...
정리하면,  먼저 이웃과의 차이**(local difference)**를 계산한 후, 계산한 차이들을 정점마다 모아 불균형**(vertex-level imbalance)**을 계산합니다.

Laplacian은 local difference에서 global imbalance 변환기가 됩니다. 
...
<img src="{{site.url}}\images\2025-04-19-network_chap4_3\eigenvalue.PNG" alt="eigenvalue" style="zoom:50%;" />
